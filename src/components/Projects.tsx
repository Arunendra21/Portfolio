...
const PROJECTS: Project[] = [
  {
    id: "codeorbit",
    title: "CodeOrbit",
    tagline: "Unified Coding Performance Dashboard",
    description: "A full-stack coding analytics platform that unifies performance data from LeetCode, Codeforces, GitHub, CodeChef, and GeeksforGeeks into a single dashboard, with 365-day activity heatmaps, consistency scoring, and LLaMA 3.3 70B (Groq) powered personalized coding recommendations.",
    features: [
      "Centralized performance tracking across five coding platforms.",
      "365-day activity heatmaps and consistency scoring.",
      "LLaMA 3.3 70B (Groq API) personalized recommendation engine.",
      "Firebase authentication with automated data synchronization workflows."
    ],
    tech: ["Next.js", "React", "TypeScript", "Node.js", "Express.js", "MongoDB", "Firebase"],
    image: "/codeorbit_logo.png",
    architecture: "Next.js Dashboard <--> Express API Core <--> MongoDB & Groq LLaMA 3.3 70B Engine",
    github: "https://github.com/Arunendra21/Codeorbit",
    demo: "https://codeorbit-psi.vercel.app/",
  },
  {
    id: "worsegpu",
    title: "Worse GPU Allocator",
    tagline: "GPU Memory Allocator Simulator",
    description: "A dependency-free Python simulator that models GPU memory allocation strategies and their failure modes — fragmentation, oversizing, leaks, and CPU fallback — entirely without CUDA hardware, built for reproducible benchmarking.",
    features: [
      "Core WorseGPUAllocator with allocate / free, deterministic seeding, and event tracing.",
      "Invariant validation for reproducible, verifiable benchmarking.",
      "CLI demo and benchmark tooling with a full unittest suite.",
      "ruff / mypy static checks, documented via an SRS and threat model."
    ],
    tech: ["Python", "unittest", "ruff", "mypy"],
    image: "/worsegpu.png",
    isBlueprint: true,
    architecture: "WorseGPUAllocator Core <--> Event Tracer & Invariant Validator <--> CLI + Benchmark Harness",
    github: "https://github.com/Arunendra21",
    demo: "https://github.com/Arunendra21",
  },
  {
    id: "scholarsynth",
    title: "ScholarSynth",
    tagline: "AI Research Paper Analysis Platform",
    description: "An AI-powered research paper analysis platform that automates extraction of key research insights from PDF documents using Google Gemini 2.5 Flash, with clean LaTeX math rendering. Built during the NIT Warangal research internship.",
    features: [
      "Gemini 2.5 Flash powered PDF insight extraction.",
      "Automated summaries and key-insight digests from dense papers.",
      "One-click LaTeX mathematical formula rendering via KaTeX.",
      "Fast Vite-based React + TypeScript client."
    ],
    tech: ["React", "TypeScript", "Vite", "Tailwind CSS", "KaTeX", "Google Gemini 2.5 Flash"],
    image: "/scholarsynth.png",
    architecture: "React + Vite Client <--> Google Gemini 2.5 Flash API <--> KaTeX Formula Renderer",
    github: "https://github.com/Arunendra21",
    demo: "https://github.com/Arunendra21",
  },
];
